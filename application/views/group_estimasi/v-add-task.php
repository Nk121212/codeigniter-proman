                                                    ...
                                                    <div class="card-body pt-0 px-1">
                                                        ...
                                                        <div class="card-body text-center">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                //echo $res;
                                                                if($res == 1){
                                                                    //echo 'show internal only';
                                                                    echo '
                                                                    <div class="col-lg-6 md-form">
                                                                    <select name="res_internal" id="res_internal" class="mdb-select md-form colorful-select dropdown-primary">
                                                                    <option value="" disabled selected>Resource Internal</option>
                                                                    <option value="-">-</option>
                                                                    ';
                                                                    foreach($qdept->result() as $data){
                                                                        echo '
                                                                    ...
                                                                    //echo 'show external only';
                                                                    echo '
                                                                    <div class="col-lg-6 md-form" style="margin-top:48px;">
                                                                        <input type="text" name="res_external" id="res_external" class="form-control">
                                                                        <label for="res_external" class="iser">Resource External</label>
                                                                    </div>
                                                                    ';
                                                                }elseif($res == 3){
                                                                    //echo 'show internal dan external';
                                                                    echo '
                                                                    <div class="col-lg-6 md-form">
                                                                    <select name="res_internal" id="res_internal" class="mdb-select md-form colorful-select dropdown-primary">
                                                                    <option value="" disabled selected>Resource Internal</option>
                                                                    ...
                                                                    echo 'Choose Resource on Input project';
                                                                }
                                                                ?>
...
<script>
    $(document).ready(function(){
        ...
        document.getElementById("page").innerHTML = "<a href='<?php echo base_url();?>c_task/index'>All Project</a> || <a>Add Task</a>";
    })
