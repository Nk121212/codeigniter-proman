...
<body class="fixed-sn black-skin">
                    ...
                    <div class="panel-group">
                        ...
                        <div class="card collapse show" id="collapseExample2">
                            ...
                            <div class="card-body">
                                ...
                                <a href="<?php echo base_url();?>c_manual/print_manual" class="btn btn-secondary">Print Manual</a>
                                ...
                                <div id="div_s1" class="col-lg-12 md-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 md-form">
                                            ...
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/estimasi/create_project.png" class="img-fluid " alt="smaple image">
                                        ...
                                        <div class="col-lg-6 md-form"> 
                                            ...
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/estimasi/create_project2.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/estimasi/create_project3.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/estimasi/detail_project2.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/estimasi/task_insert.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/estimasi/view_task.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/estimasi/add_material.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/estimasi/add_material2.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/estimasi/add_material3.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/estimasi/todolist.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                    ...
                                    <div align="right">
                                        <button class="btn btn-success step_2">Next Step <i class="fa fa-arrow-right"></i>
                                    </div>
                                ...
                                <div id="div_s2" class="col-lg-12 md-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 md-form">
                                                <div class="view overlay zoom pointer">
                                                    <img src="<?php echo base_url();?>image/manual_book/estimasi/todolist3.png" class="img-fluid " alt="smaple image">
                                                    <div class="mask flex-center">
                                                        <p class="white-text"></p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            ...
                                            <div class="col-lg-6 md-form">
                                                <div class="view overlay zoom pointer">
                                                    <img src="<?php echo base_url();?>image/manual_book/estimasi/proposal.png" class="img-fluid " alt="smaple image">
                                                    <div class="mask flex-center">
                                                        <p class="white-text"></p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6 md-form">
                                                <div class="view overlay zoom pointer">
                                                    <img src="<?php echo base_url();?>image/manual_book/estimasi/proposal2.png" class="img-fluid " alt="smaple image">
                                                    <div class="mask flex-center">
                                                        <p class="white-text"></p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6 md-form">
                                                <div class="view overlay zoom pointer">
                                                    <img src="<?php echo base_url();?>image/manual_book/estimasi/kick_off.png" class="img-fluid " alt="smaple image">
                                                    <div class="mask flex-center">
                                                        <p class="white-text"></p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6 md-form">
                                                <div class="view overlay zoom pointer">
                                                    <img src="<?php echo base_url();?>image/manual_book/estimasi/kick_off3.png" class="img-fluid " alt="smaple image">
                                                    <div class="mask flex-center">
                                                        <p class="white-text"></p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6 md-form">
                                                <div class="view overlay zoom pointer">
                                                    <img src="<?php echo base_url();?>image/manual_book/estimasi/finish_est.png" class="img-fluid " alt="smaple image">
                                                    <div class="mask flex-center">
                                                        <p class="white-text"></p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6 md-form">
                                                <div class="view overlay zoom pointer">
                                                    <img src="<?php echo base_url();?>image/manual_book/estimasi/finish_est2.png" class="img-fluid " alt="smaple image">
                                                    <div class="mask flex-center">
                                                        <p class="white-text"></p>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <button class="btn btn-success step_1"><i class="fa fa-arrow-left"></i> Back Step</button>
                                        </div>
                                        <div class="col-lg-6 md-form" style="text-align:right;">
                                            <button class="btn btn-success step_3">Next Step <i class="fa fa-arrow-right"></i></button>
                                        </div>
                                ...
                                <div id="div_s3" class="col-lg-12 md-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/actual/update_task.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/actual/update_task3.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/actual/update_material.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/actual/update_material4.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/actual/add_material.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/actual/comment_material.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/actual/update_todo.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/actual/update_todo3.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/actual/update_todo4.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/actual/rating3.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <button class="btn btn-success step_2"><i class="fa fa-arrow-left"></i> Back Step</button>
                                        </div>
                                        <div class="col-lg-6 md-form" style="text-align:right;">
                                            <button class="btn btn-success step_4">Next Step <i class="fa fa-arrow-right"></i></button>
                                        </div>
                                ...
                                <div id="div_s4" class="col-lg-12 md-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/report/summary.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/report/summary_grafik.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/report/status.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/report/status3.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/report/progress.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 md-form">
                                            <div class="view overlay zoom pointer">
                                                <img src="<?php echo base_url();?>image/manual_book/report/progress2.png" class="img-fluid " alt="smaple image">
                                                <div class="mask flex-center">
                                                    <p class="white-text"></p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-6 md-form">
                                        <button class="btn btn-success step_3"><i class="fa fa-arrow-left"></i> Back Step</button>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            document.getElementById("page").innerHTML = "Application Guide";
            $(".step_1").click();
//----------------------------------------------------------------------------------------------------------//
        }) 
